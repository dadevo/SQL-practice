...
--Q26: List all students in a single table, sorted by year first, then by track, then by highest averare score per student.
...
SELECT students.name, students.birthday, classes.start_date, students.track_id, [average_score].average_score
FROM students
...
ORDER BY classes.start_date, students.track_id, [average_score].average_score DESC
GO
